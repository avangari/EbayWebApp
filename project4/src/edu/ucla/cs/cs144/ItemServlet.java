...
public class ItemServlet extends HttpServlet implements Servlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
    	...
    	// String inputValue = request.getParameter("itemId");
    	// request.setAttribute("Name", inputValue);
    	
    	String inputId = request.getParameter("itemId");
    	String xmlResult = AuctionSearchClient.getXMLDataForItemId(inputId);
    	String itemName = "", started = "", currently = "", firstBid = "", 
    		buyPrice = "", noOfBids = "", sellerId = "", location = "", longitude = "",
    		latitude = "", country = "", description = "";
    	try
    	{
    		...
    		itemName = doc.getElementsByTagName("Name").item(0).getTextContent();
